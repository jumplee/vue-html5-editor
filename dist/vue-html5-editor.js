 ...
 * build at Fri Jan 11 2019 20:31:19 GMT+0800 (CST)
 */

var VueHtml5Editor = (function () {
    'use strict';
    ...
    var vueUploader = /******/ (function(modules) { // webpackBootstrap
    /******/ 	// The module cache
    ...
    /* harmony import */ var _uploader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../uploader */ "./src/uploader.js");
    ...
    /* harmony import */ var _baseViewCtrl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../baseViewCtrl */ "./src/baseViewCtrl.js");
    /* harmony import */ var _baseViewCtrl__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_baseViewCtrl__WEBPACK_IMPORTED_MODULE_1__);
    ...
    */};
    ...
    var Component = Object(_node_modules_vue_loader_lib_runtime_component_normalizer__WEBPACK_IMPORTED_MODULE_2__["default"])(
      _babel_loader_main_js__WEBPACK_IMPORTED_MODULE_0__["default"],
    ...
    RangeHandler.prototype.execCommand = function execCommand (command, arg) {
        ...
        switch (command) {
            ...
            case Command.INSERT_HTML: {
                ...
                div$2.innerHTML = arg;
                if (div$2.hasChildNodes()) {
                    for (var i$1 = 0; i$1 < div$2.childNodes.length; i$1++) {
                        fragment$2.appendChild(div$2.childNodes[i$1].cloneNode(true));
                    }
                }
                this.range.deleteContents();
                this.range.insertNode(fragment$2);
                break
            }
            case Command.BOLD: {
    ...
    var VueHtml5Editor = function VueHtml5Editor(options) {
        ...
        // 将插件注册到组件中
        components['plugin-draft'] = draft$2;
        // i18n
